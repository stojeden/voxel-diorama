...
export const CHECKPOINTS: Record<CheckpointId, CheckpointDefinition> = {
  train: checkpoint('train', 0.42, [52, 18, 23], [30, 4, 2], null, 'classic', 'clear', 0.68),
  bus: checkpoint('bus', 0.46, [48, 12, -18], [27, 3, -10], null, 'classic', 'clear', undefined, 0.25),
  ...
  totality: checkpoint('totality', 0.715, FIXED_TOUR_SHOTS.totality.position, FIXED_TOUR_SHOTS.totality.target, 0.5),
  cyberpunk: checkpoint('cyberpunk', 0.86, FIXED_TOUR_SHOTS.cyberpunk.position, FIXED_TOUR_SHOTS.cyberpunk.target, null, 'cyberpunk'),
  'golden-clear-overview': checkpoint('golden-clear-overview', 0.28, OVERVIEW_SHOT.position, OVERVIEW_SHOT.target),
  'noon-rain-overview': checkpoint('noon-rain-overview', 0.5, OVERVIEW_SHOT.position, OVERVIEW_SHOT.target, null, 'classic', 'rain'),
  'night-snow-train': checkpoint('night-snow-train', 0.02, OVERVIEW_SHOT.position, OVERVIEW_SHOT.target, null, 'classic', 'snow', 0.68),
  'evening-rain-bus': checkpoint('evening-rain-bus', 0.82, OVERVIEW_SHOT.position, OVERVIEW_SHOT.target, null, 'classic', 'rain', undefined, 0.25),
  'eclipse-totality-overview': checkpoint('eclipse-totality-overview', 0.715, FIXED_TOUR_SHOTS.totality.position, FIXED_TOUR_SHOTS.totality.target, 0.5),
};
...
function checkpoint(
  ...
  eclipseProgress: number | null = null,
  theme: 'classic' | 'cyberpunk' = 'classic',
